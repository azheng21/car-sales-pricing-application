...
public class CarConfiguration extends HttpServlet implements client.SocketClientConstants {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		if (automobileKey == null) {
			...
			errorMessageBuffer.append("<a href=\"/carapp/CarSelection\">Automobile selection</a>");
			errorFlag = true;
		} else {
			try {
		...
		if (errorFlag) {
			...
			out.println("<form method=\"get\" action=\"/carapp/CarPrice.jsp\">");
			...
			out.println("<a href=\"/carapp/CarSelection\">back</a>");
